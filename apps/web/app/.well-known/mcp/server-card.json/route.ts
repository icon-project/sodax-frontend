  ...
  servers: [
    {
      ...
      tools: [
        { name: 'sodax_get_supported_chains', description: 'List all blockchain networks supported by SODAX for cross-chain swaps and DeFi operations.' },
        { name: 'sodax_get_swap_tokens', description: 'Get available tokens for swapping on SODAX, optionally filtered by chain.' },
        { name: 'sodax_get_transaction', description: 'Look up a specific transaction by its hash.' },
        { name: 'sodax_get_user_transactions', description: 'Get intent/transaction history for a specific wallet address.' },
        ...
        { name: 'sodax_get_money_market_assets', description: 'All assets available for lending and borrowing on the SODAX money market.' },
        { name: 'sodax_get_money_market_asset', description: 'Detailed information for a specific money market asset.' },
        { name: 'sodax_get_money_market_tokens', description: 'Tokens supported for money market lending/borrowing, optionally filtered by chain.' },
        { name: 'sodax_get_money_market_reserve_assets', description: 'Money market reserve assets used as collateral backing.' },
        { name: 'sodax_get_user_position', description: "A user's lending and borrowing position in the money market." },
        ...
        { name: 'sodax_get_all_borrowers', description: 'All borrowers across all money market assets with pagination.' },
        { name: 'sodax_get_amm_positions', description: 'AMM liquidity-provider NFT positions, optionally filtered by owner.' },
        ...
        { name: 'sodax_get_partners', description: 'SODAX integration partners including wallets, DEXs, and other protocols.' },
        { name: 'sodax_get_partner_summary', description: 'Volume and activity summary for a specific integration partner.' },
        ...
        { name: 'sodax_get_all_config', description: 'Full SODAX configuration (chains, tokens, protocol settings) in one call.' },
        { name: 'sodax_get_all_chains_configs', description: 'Detailed configuration for all spoke chains (contracts, RPCs, tokens).' },
    ...
    },
    {
      ...
      tools: [
        { name: 'sodax_get_voice_guardrails', description: 'Voice & Guardrails — terminology rules, allowed claims, voice principles, and common mistakes to avoid. Check before publishing any SODAX content.' },
        { name: 'sodax_refresh_voice_guardrails', description: 'Force a refresh of Voice & Guardrails from Notion.' },
        { name: 'sodax_get_brand_assets_overview', description: 'Overview of the SODAX visual identity system (colors, logos, typography, usage guidelines).' },
        { name: 'sodax_get_brand_colors', description: 'Official SODAX color palette with hex codes. Filterable by group (primary/secondary/neutral).' },
        ...
        { name: 'sodax_get_usage_guidelines', description: 'SODAX visual identity usage rules and implementation standards.' },
        { name: 'sodax_refresh_brand_assets', description: 'Force refresh brand assets from Notion.' },
        { name: 'sodax_get_glossary_overview', description: 'Overview of the SODAX Technical Glossary (System Concepts + System Components).' },
        ...
        { name: 'sodax_translate_term', description: 'Translate a SODAX technical term into simple language for non-technical audiences.' },
        ...
        { name: 'sodax_get_stats_overview', description: 'High-level snapshot of SODAX live metrics (networks, partners, token, activity).' },
        ...
        { name: 'sodax_get_token_supply', description: 'SODA token economics: total, circulating, locked supply and DAO fund balance.' },
        ...
        { name: 'sodax_get_integration_profiles_overview', description: 'Overview of all SODAX integration profiles (DEXs, wallets, lending, solver marketplaces, networks).' },
        { name: 'sodax_list_integration_profiles', description: 'List integration profiles with categories, examples, and previews.' },
        { name: 'sodax_get_integration_profile', description: 'Full positioning profile for an integration type (pitch angles, proof points, objection handling, messaging).' },
        ...
        { name: 'sodax_get_sitemap', description: 'All canonical SODAX page URLs from the official sitemap. Use to verify URLs and avoid impostor domains.' },
        ...
        { name: 'sodax_get_boilerplate', description: 'Pre-approved SODAX boilerplate copy. Variants: one-liner, social-bio, short, medium, long/press-kit, developer, user-facing, partner-template.' },
        { name: 'sodax_list_boilerplates', description: 'List boilerplate variants with audience and length metadata.' },

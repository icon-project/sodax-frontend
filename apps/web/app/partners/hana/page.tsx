...
export default function HanaPage() {
  return (
    <PartnerPageLayout metadata={partnerMetadata}>
      ...
      <AnimatedSection className="flex flex-col md:flex-row md:justify-between md:items-start gap-4 w-full">
        <div className="flex gap-3 md:gap-4 items-center">
          ...
          <div className="flex flex-col items-start justify-center">
            <p className="font-['InterMedium'] text-xs md:text-sm text-clay-light uppercase leading-tight tracking-wider">
              CASE STUDY: SDK INTEGRATION
            </p>
            <p className="font-['InterBold'] text-2xl md:text-3xl lg:text-4xl text-espresso leading-tight">
              Hana
            </p>
            <p className="font-['InterBold'] text-sm md:text-base lg:text-lg text-clay leading-normal">
      ...
      <div className="flex flex-col lg:flex-row gap-6 items-start w-full">
        ...
        <AnimatedStaggerContainer className="flex-1 flex flex-col gap-6 items-start min-w-0 w-full lg:w-auto">
          ...
          <AnimatedFadeIn className="flex flex-col items-start w-full">
            <div className="bg-almost-white flex items-center px-3 py-4 md:px-4 md:py-6 rounded-lg w-full relative">
              <p className="flex-1 font-['InterRegular'] text-sm md:text-base text-espresso leading-relaxed">
          ...
          <AnimatedStaggerChild className="flex items-start w-full">
            <div className="flex-1 flex flex-col gap-2 items-start leading-normal">
              <p className="font-['InterBold'] text-lg text-espresso w-full">The Partner</p>
              <p className="font-['InterRegular'] text-sm text-clay-dark w-full">
          ...
          <AnimatedStaggerChild className="flex items-start w-full">
            <div className="flex-1 flex flex-col gap-2 items-start">
              <p className="font-['InterBold'] text-lg text-espresso w-full leading-normal">The Challenge</p>
              <p className="font-['InterRegular'] text-sm text-clay-dark w-full leading-normal">
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 items-start w-full">
                <div className="flex-1 flex flex-col items-center justify-center pt-2 border-t border-cream-white min-w-0 w-full">
                  <p className="font-['InterRegular'] text-sm text-clay-dark w-full leading-normal">
              ...
              <p className="font-['InterRegular'] text-sm text-clay-dark w-full leading-normal mt-2">
          ...
          <AnimatedStaggerChild className="flex flex-col gap-2 items-start w-full">
            <p className="font-['InterBold'] text-lg text-espresso w-full leading-normal">The Solution</p>
            <p className="font-['InterRegular'] text-sm text-clay-dark w-full leading-normal">
              SODAX's SDK removed cross-network complexity. Hana gained three core capabilities:
            </p>
            <div className="flex flex-col gap-2 items-start w-full">
              {/* Bullet 1 */}
              <div className="flex gap-2 items-start py-4 border-t border-cream-white w-full">
                <div className="bg-cherry-brighter flex flex-col items-center justify-center rounded-full shrink-0 w-4 h-4">
                  <p className="font-['InterBold'] text-[8px] text-white leading-normal">1</p>
                </div>
                <div className="flex-1 flex flex-col items-center justify-center min-w-0">
                  <p className="font-['InterBold'] text-sm text-cherry-soda w-full leading-snug">
        ...
        {/* Side panel */}
        <AnimatedScrollSection className="bg-almost-white flex flex-col gap-2 items-start px-4 py-6 rounded-lg shrink-0 w-full lg:w-[280px]">
          <div className="flex-1 flex flex-col gap-4 items-start w-full">
            {/* At a glance */}
            <div className="flex flex-col gap-2 items-start w-full">
              <p className="font-['InterBold'] text-lg text-cherry-bright w-full leading-normal">
                At a glance
              </p>
              <ul className="font-['InterRegular'] text-sm text-clay-dark w-full list-disc ml-4 space-y-1">
                <li>
            ...
            <div className="h-px w-full bg-cream-white" />

            {/* About Hana */}
            <div className="flex flex-col gap-2 items-start w-full">
              <p className="font-['InterBold'] text-lg text-cherry-bright w-full leading-normal">About Hana</p>
              <div className="flex flex-col gap-1 items-start w-full">
                <div className="bg-cream-white flex flex-col gap-1 items-start px-3 py-2 rounded w-full">
                  <p className="font-['InterBold'] text-sm text-espresso">47,000+</p>
                  <p className="font-['InterRegular'] text-xs text-clay-dark">Installed users</p>
                </div>
                <div className="bg-cream-white flex flex-col gap-1 items-start px-3 py-2 rounded w-full">
                  <p className="font-['InterBold'] text-sm text-espresso">Web3 Mastercard</p>
                  <p className="font-['InterRegular'] text-xs text-clay-dark">
                    Real-world spending capability
                  </p>
                </div>
                <div className="bg-cream-white flex flex-col gap-1 items-start px-3 py-2 rounded w-full">
                  <p className="font-['InterBold'] text-sm text-espresso">Key Partnerships</p>
                  <p className="font-['InterRegular'] text-xs text-clay-dark">
            ...
            {/* Quote */}
            <div className="flex flex-col gap-2 items-start w-full">
              <p className="font-['InterBold'] text-lg text-cherry-bright w-full leading-normal">Quote</p>
              <p className="font-['InterRegular'] text-base text-clay-light w-full leading-relaxed">
              ...
              <p className="font-['InterRegular'] text-sm text-clay-dark w-full text-right">
                <span className="font-['InterBold'] text-espresso">— Hana Wallet Team</span>
              </p>
            </div>
          </div>

          {/* References */}
          <div className="flex flex-col gap-2 items-start pt-2 border-t border-cream-white w-full">
            <p className="font-['InterRegular'] text-sm text-clay leading-normal">References</p>
            <div className="flex gap-2 items-center">
              <a
                href="https://www.hana.money/"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex h-9 items-center justify-center gap-1.5 px-3 py-1.5 min-w-[110px] bg-white hover:bg-gray-50 border border-cream-white rounded-lg transition-colors"
              >
                <Globe size={14} className="text-espresso" />
                <span className="font-['InterMedium'] text-sm text-espresso">Website</span>
              </a>
              <a
                href="https://twitter.com/hanawallet"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center h-9 justify-center gap-1.5 px-3 py-1.5 min-w-[110px] bg-white hover:bg-gray-50 border border-cream-white rounded-lg transition-colors"
              >
                <svg
                  width="14"
                  height="14"
                ...
                <span className="font-['InterMedium'] text-sm text-espresso">X</span>
              </a>
            </div>
          </div>
        </AnimatedScrollSection>
      ...
      {/* Bottom Section */}
      <AnimatedStaggerContainer className="bg-almost-white flex flex-col lg:flex-row gap-6 md:gap-4 items-start p-3 md:p-6 lg:p-8 w-full rounded-lg">
        {/* Hana Results */}
        <AnimatedFadeIn className="flex-1 flex flex-col gap-2 items-start min-w-0 w-full lg:w-auto">
          <div className="flex gap-1 items-center w-full">
            ...
            <p className="font-['InterBold'] text-base md:text-lg text-espresso leading-normal">
              Hana Results
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:flex lg:flex-wrap gap-3 md:gap-2 items-start pb-2 w-full">
            <div className="flex flex-col gap-1 items-center justify-center pl-4 py-2 border-l border-cream-white w-full lg:w-[170px]">
              <p className="font-['InterBold'] text-sm text-espresso w-full leading-normal">
        ...
        <AnimatedStaggerChild className="flex flex-col items-start justify-start gap-6 shrink-0 w-full lg:w-auto">
          ...
          <div className="flex flex-col gap-2 items-start rounded-lg shrink-0 w-full lg:w-[280px]">
            <div className="flex gap-1 items-center w-full">
              ...
              <p className="flex-1 font-['InterBold'] text-sm text-espresso leading-normal min-w-0">
                SODAX Integration
              </p>
            </div>
            <div className="flex flex-col items-start w-full">
              <div className="flex flex-col gap-3 items-start w-full">
                ...
                <div className="bg-cream-white flex flex-col gap-1 items-start justify-center p-2 rounded-lg shrink-0 w-full lg:w-[280px]">
                  <p className="font-['InterRegular'] text-sm text-clay-dark leading-normal">
                    Foundation Layer
                  </p>
                  <div className="flex flex-col items-start text-xs w-full leading-tight">
                    ...
                    <p className="font-['InterRegular'] text-clay-dark w-full">
          ...
          {/* Get started */}
          <div className="flex flex-col gap-2 items-start w-full lg:w-auto border-t border-cream-white pt-4 lg:border-0 lg:pt-0">
            <div className="flex gap-1 items-center w-full">
              <div className="relative shrink-0 w-4 h-4">
                <Image
                  alt="SODAX symbol"
            ...
            <div className="flex flex-col gap-2 items-start shrink-0 w-full lg:w-[280px]">
              <p className="font-['InterRegular'] text-sm text-clay leading-tight">
                <span className="font-['InterBold'] text-espresso">Arosh Ediriweera,</span>
                <br />
                Partnerships Manager{' '}
                <a className="underline hover:text-espresso transition-colors" href="mailto:arosh@sodax.com">
                  arosh@sodax.com
                </a>
              </p>
            </div>

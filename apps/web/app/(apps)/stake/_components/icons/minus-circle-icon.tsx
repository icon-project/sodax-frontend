const MinusCircleIcon = ({ width = 16, height = 16, stroke = '#483534', ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 16 16" fill="none" {...props}>
    ...
    />
    <path d="M5.33301 8H10.6663" stroke={stroke} strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);

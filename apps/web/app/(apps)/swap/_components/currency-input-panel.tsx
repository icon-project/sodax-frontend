...
const CurrencyInputPanel: React.FC<CurrencyInputPanelProps> = ({
  ...
  return (
    <div className="relative w-full group">
      ...
      <div
        className={`absolute inset-0 rounded-(--layout-container-radius) outline-almost-white pointer-events-none ${className} outline-2 outline-offset-2 group-hover:outline-4 group-hover:outline-offset-4 sm:outline-3 sm:outline-offset-[-3px] sm:group-hover:outline-5 sm:group-hover:outline-offset-[-5px] md:outline-4 md:outline-offset-[-4px] md:group-hover:outline-6 md:group-hover:outline-offset-[-6px]`}
        style={{ mixBlendMode: 'multiply' }}
      />
      {/* Content layer without blend mode */}
      <div
        className="w-full relative rounded-(--layout-container-radius) justify-between items-center"

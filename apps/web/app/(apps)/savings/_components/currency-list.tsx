...
export default function CurrencyList() {
  ...
  const uniqueTokenSymbols = getUniqueTokenSymbols(tokens);
                  ...
                  <ItemContent>
                    ...
                    <div className="flex w-full justify-between">
                      <div className="flex items-center">
                        {tokens.map(token => (
                          <NetworkIcon key={token.xChainId} imageSrc={token.name} />
                        ))}
                      </div>
                      <div className="flex items-center gap-1">
              ...
              <AccordionContent className="pl-0 md:pl-18 pb-8 flex flex-col gap-4">
                ...
                <div className="flex items-center">
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="text-clay text-(length:--body-small) font-['InterRegular'] text-center">WBTC</div>
                  </div>
                </div>

  ...
  return (
    <div className={`w-16 h-14 relative ${className}`}>
      <div data-property-1="Default" className="w-12 h-12 left-[8px] top-[4px] absolute">
        ...
        >
          <Image className="w-6 h-6 rounded-[256px]" src="/coin/soda.png" alt="SODA" width={24} height={24} />
        </div>
        <div
        ...
        >
          <Image className="w-4 h-4" src="/coin/s1.png" alt="SODA" width={16} height={16} />
        </div>
      </div>
    </div>
  );

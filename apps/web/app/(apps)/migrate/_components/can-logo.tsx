...
const CanLogo: React.FC<CanLogoProps> = ({ className = '', currency, isChainConnected = false }) => {
  return (
    <div data-property-1="Default" className="w-14 h-14 mx-1 relative">
      ...
      <Image className="left-[9px] top-0 absolute" src="/can1.png" alt="CAN" width={38} height={56} />
      <Image
        ...
        height={20}
      />
      <div data-property-1="Medium" className="w-4 h-4 left-[36px] top-[36px] absolute">
        <div

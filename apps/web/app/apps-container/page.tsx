...
const AppsContainer = () => {
  ...
  return (
    <div className="w-full bg-cream-white min-h-screen">
      <div className="self-stretch h-60 px-28 py-9 relative inline-flex flex-col justify-start items-center gap-2 w-full">
        <div className="w-full h-60 left-0 top-0 absolute bg-gradient-to-r from-[#BB7B70] via-[#CC9C8A] to-[#B16967]" />
        <div className="w-full max-w-[1200px] min-w-[944px] justify-between items-center h-10 z-1 inline-flex">
          <div className="flex justify-start items-center gap-8">
            ...
            <div className="justify-center text-cream">
              <span className="text-xs font-bold font-['InterRegular'] leading-none">Money, as it </span>
              <span className="text-xs font-normal font-['Shrikhand'] leading-none">should</span>

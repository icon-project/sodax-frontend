                    ...
                    <div className="bg-white text-black rounded-lg max-h-[200px] overflow-y-auto [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-track]:bg-cream [&::-webkit-scrollbar-thumb]:bg-cream [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:h-[108px]">
                      <div className="space-y-4 text-xs leading-relaxed text-clay mr-6">
                        <p>
                          ...
                          documents they expressly incorporate by reference (collectively, these “Terms of Use”), govern
                          your access to and use of sodax.com and any subdomains thereof (the “Services”) and use of our
                          mobile applications (the “Apps” and together with the Services, the “Services”).
                        </p>
                        <p>
                          If the user engages with the Services under authority from a different party or on another
                          party’s behalf, then “you” (and its variants, including “your”, “yours”, etc.) as used herein
                          refers to that person on whose behalf the Services are used (e.g., an employer). If the person
                          engaging with our Services is an individual, acting in their own individual capacity, then
                          “you” (and its variants) refers to that individual. If you have anyone using the Services on
                          your behalf, you agree that you are responsible for the actions and inactions of all such
                        ...
                        <p>
                          ...
                          FACILITATE ACCESS TO THE RELEVANT PROTOCOL AND/OR SMART CONTRACTS. WE DO NOT OWN, CONTROL, OR
                          HAVE ANY RESPONSIBILITY FOR THE SODA PROTOCOL OR THE SODAX SMART CONTRACTS. THESE TERMS OF USE
                          DO NOT GOVERN YOUR USE OF THE PROTOCOL OR THE SODAX SMART CONTRACTS, WHICH ARE CONTROLLED,
                        ...
                        <p>
                          YOU AGREE THAT DISPUTES (AS DEFINED BELOW) ARISING OUT OF OR RELATED TO THESE TERMS OF USE OR
                          THE SERVICES WILL BE RESOLVED BY BINDING INDIVIDUAL ARBITRATION, AND BY ACCEPTING THESE TERMS
                        ...
                        <p>
                          ...
                          clicking “I agree” (or a similar language) to these Terms of Use, acknowledging these Terms of
                          Use by other means, or otherwise accessing or using the Services, you also accept and agree to
                          be bound by and to comply with these Terms of Use. If you do not want to agree to these Terms
                          of Use, you must not access or use the Services.
                        </p>
                        <p>
                          BY USING THE SERVICES, YOU ACKNOWLEDGE, UNDERSTAND AND AGREE THAT (i) YOU ARE NOT PERMITTED TO
                          MODIFY, DISASSEMBLE, DECOMPILE, ADAPT, ALTER, TRANSLATE, REVERSE ENGINEER OR CREATE DERIVATIVE
                          WORKS OF THE SERVICES TO MAKE IT AVAILABLE TO ANY BLOCKED PERSONS OR RESTRICTED PERSONS; AND
                          (ii) WE DO NOT AND WILL NOT HAVE CONTROL OVER THE DEVELOPMENT, GROWTH, MAINTENANCE OR
                          OPERATIONS OF ANY PROTOCOL OR SMART CONTRACT THAT YOU MAY BE ABLE TO ACCESS FROM OR THROUGH
                          THE SERVICES, OR THEIR UNDERLYING SOFTWARE.
                        </p>
                        <p>
                        ...
                        <p>
                          ...
                          <br /> We reserve the right to withdraw or amend the Services, and any service or material we
                          provide on the Services, in our sole discretion without notice. We will not be liable if for
                          any reason all or any part of the Services are unavailable at any time or for any period. From
                          time to time, we may restrict access to some parts of the Services, or all of the Services, to
                          users.
                        </p>
                        <p>
                          You are responsible for:
                          <br /> Making all arrangements necessary for you to have access to the Services. Ensuring that
                          all persons who access the Services through your internet connection or on your behalf are
                          aware of these Terms of Use and comply with foregoing.
                        </p>
                        <p>
                        ...
                        <p>
                          Trademarks
                          <br /> Company’s name, the terms “SODAX” and “Soda Xchange”, Company’s logos, and all related
                          names, logos, product and service names, designs, and slogans are trademarks of Company or
                          Company’s licensors. You must not use such marks without the prior written permission of
                          Company or Company’s licensors, as applicable.
                        </p>
                        <p>
                          ...
                          independent from and unaffiliated with Company. Any use of this software is subject to the
                          terms and conditions laid out herein.
                        </p>
                        <p>
                        ...
                        <p>
                          Prohibited Uses
                          <br /> You may use the Services only for lawful purposes and in accordance with these Terms of
                          Use. You agree not to use the Services: In any way that violates any applicable federal,
                          ...
                          <br /> For the purpose of exploiting, harming, or attempting to exploit or harm minors in any
                          way by exposing them to inappropriate content, asking for personally identifiable information,
                          or otherwise.
                          <br /> To send, knowingly receive, upload, download, use, or re-use any material that does not
                          comply with these Terms of Use. To transmit, or procure the sending of, any advertising or
                          promotional material, including any “junk mail”, “chain letter”, “spam”, or any other similar
                          solicitation.
                          <br /> To impersonate or attempt to impersonate Company, a Company employee or representative,
                          ...
                          <br /> To engage in any other conduct that restricts or inhibits anyone’s use or enjoyment of
                          the Services, or which, as determined by us, may harm Company or users of the Services or
                          expose them to liability.
                          <br /> Additionally, you agree not to: <br /> Allow any third party to access the Services on
                          your behalf or using your credentials. Accessing or attempting to access restricted portions
                          of the Services, security software or other administrative applications associated therewith.
                          <br />
                          Use the Services in any manner that could disable, overburden, damage, or impair the Services
                          or interfere with any other party’s use of the Services, including their ability to engage in
                          ...
                          intended to do harm or allow unauthorized access, including, for example, viruses, worms, time
                          bombs, back doors and Trojan horses (collectively, “Malicious Code”) on or through the
                          Services, or accessing or attempting to access the Services for the purpose of infiltrating a
                          computer or computing system or network, or damaging the software components of the Services,
                          or the systems of the hosting provider, any other suppliers or service provider involved in
                          providing the Services, or another user.
                          <br /> Distribute Malicious Code or other items of a destructive or deceptive nature.
                          <br /> Attempt to gain unauthorized access to, interfere with, damage, or disrupt any parts of
                          ...
                          constitute, promote, or are used primarily for the purpose of dealing in phishing, spyware,
                          adware, or other malicious programs or code, counterfeit goods, items subject to applicable
                          jurisdictions’ embargoes, hacking, stolen products, and items used for theft, hazardous
                          materials, or any illegal activities. Pose as another person or entity without authorization.
                          <br />
                          ...
                          <br /> Use the Services, directly or indirectly, for, on behalf of, for the benefit of, or in
                        ...
                        <p>
                          ...
                          acknowledge and agree that such protocol and bridge smart contract are controlled, maintained
                          and/or operated by third parties, and we do not own, operate, provide, control, or have any
                          responsibility for such protocol or smart contract. Please consult such third parties’ user
                          agreements for information regarding your use of and access to the protocol and the smart
                          contract.
                        </p>
                        <p>
                        ...
                        <p>
                          ...
                          <br /> The Services allow you access to on-chain protocols or other methods of transacting in
                          Digital Assets. That functionality is not provided by Company, and we do not control it. Our
                          Services make such functionalities accessible only as a convenience to you.
                        </p>
                        <p>
                        ...
                        <p>
                          ...
                          including (but not limited to) remote procedure call node (“RPC node”) operators. An RPC node
                          is a type of computer server that allows users to read data from and send transactions to a
                          blockchain network. We do not operate any RPC nodes and are not responsible for the operation
                          of any RPC nodes required for your successful interaction with on-chain protocols or
                          transacting in Digital Assets. Any RPC nodes that you rely on or use are independent from and
                          unaffiliated with Company and Company shall not be held liable for the operation of any RPC
                          nodes or the function or service to be performed by those RPC nodes.
                        </p>
                        <p>
                        ...
                        <p>
                          ...
                          legal and does not damage our reputation or take advantage of it, but you must not establish a
                          link in such a way as to suggest any form of association, approval, or endorsement on our part
                          without our express written consent in each instance.
                        </p>
                        <p>
                        ...
                        <p>
                          ...
                          <br /> Cause the Services or portions of it to be displayed on, or appear to be displayed by,
                        ...
                        <p>
                          You agree to cooperate with us in immediately stopping any unauthorized framing or linking. We
                        ...
                        <p>
                          ...
                          (without limitation) materials provided by other users, and third-party licensors and service
                          providers. If you have any questions about the policies and practices of such third-party
                          service providers, please consult their respective terms and conditions.
                        </p>
                        <p>
                        ...
                        <p>
                          ...
                          external to our Services for any reconstruction of any lost data, including any information in
                          your wallet.
                        </p>
                        <p>
                          ...
                          THAT MAY INFECT YOUR COMPUTER EQUIPMENT, COMPUTER PROGRAMS, DATA, YOUR WALLET, OR PROPRIETARY
                          MATERIAL DUE TO YOUR USE OF THE SERVICES, YOUR TRANSACTIONS OR EXCHANGES THROUGH TOOLS
                          ACCESSED THROUGH THE SERVICES, OR YOUR ACCESS TO ANY MATERIAL, PROTOCOLS, SMART CONTRACTS OR
                          OTHER TOOLS PROVIDED ON OR THROUGH THE SERVICES, POSTED ON THEM, OR POSTED ON ANY THIRD-PARTY
                          CONTENT OR BLOCKCHAINS LINKED TO THE SERVICES.
                        </p>
                        <p>
                        ...
                        <p>
                          ...
                          SHAREHOLDERS, OWNERS, MEMBERS, OFFICERS, OR DIRECTORS BE LIABLE FOR DAMAGES OF ANY KIND, UNDER
                          ANY LEGAL THEORY, ARISING OUT OF OR IN CONNECTION WITH YOUR USE OF OR ACCESS TO, OR INABILITY
                          TO USE OR ACCESS, THE SERVICES, THE THIRD-PARTY PROTOCOL OR ANY SMART CONTRACTS MADE
                          ACCESSIBLE ON OR THROUGH THE SERVICES, ANY WEBSITES LINKED TO THE SERVICES, ANY CONTENT ON THE
                          SERVICES OR SUCH OTHER WEBSITES, INCLUDING ANY DIRECT, INDIRECT, SPECIAL, INCIDENTAL,
                        ...
                        <p>
                          Force Majeure
                          <br /> We shall not be liable or responsible to you, nor be deemed to have defaulted under or
                          breached these Terms of Use, for any failure or delay in performance when and to the extent
                          such failure or delay is caused by or results from acts beyond our reasonable control,
                          including but not limited to: acts of God, flood, fire, earthquake, epidemics, pandemics,
                          quarantine restrictions, explosion, war, terrorism, invasion, hostilities (whether war is
                          declared or not), civil unrest, riots, government action, embargoes or blockades, sanctions,
                          failure of public or private telecommunications networks or internet services, power outages,
                          denial of service attacks or other cyberattacks, failure of third-party services (including
                          decentralized protocols, blockchain networks, and RPC nodes), strikes, labor stoppages or
                          slowdowns, or other industrial disturbances, or other events beyond our reasonable control. In
                          such cases, our obligations under these Terms of Use shall be suspended for so long as the
                          event continues to impede our performance.
                        </p>
                        <p>
                          Indemnification
                        ...
                        <p>
                          ...
                          Terms of Use. Unless expressly provided to the contrary in these Terms of Use, a person who is
                          not a party to these Terms of Use shall not have any rights under the Contracts (Rights of
                          Third Parties) Act (as amended) of the Cayman Islands to enforce any term of these Terms of
                          Use. Notwithstanding any term of these Terms of Use, the consent of or notice to any person
                          who is not a party to these Terms of Use shall not be required for any termination, rescission
                          or agreement to any variation, waiver, assignment, novation, release or settlement under these
                          Terms of Use at any time.
                        </p>
                        <p>
                          Governing Law and Dispute Resolution
                          <br /> PLEASE READ THIS SECTION CAREFULLY BECAUSE IT MAY SIGNIFICANTLY IMPACT YOUR LEGAL
                          RIGHTS, INCLUDING YOUR RIGHT TO BRING A LAWSUIT AGAINST COMPANY. THIS SECTION REQUIRES YOU TO
                          SUBMIT ANY CONTROVERSY, DISPUTE, CLAIM OR DISAGREEMENT (EACH A “DISPUTE”) ARISING OUT OF THESE
                          TERMS OF USE OR THE SERVICES, INCLUDING ANY DISPUTE THAT AROSE BEFORE THE EFFECTIVE DATES OF
                          THESE TERMS OF USE, TO BINDING INDIVIDUAL ARBITRATION. THIS SECTION EXTENDS TO DISPUTES THAT
                          AROSE OR INVOLVE FACTS OCCURING BEFORE THE EXISTENCE OF THIS SECTION OR ANY PRIOR VERSIONS OF
                          THESE TERMS OF USE AS WELL AS DISPUTES THAT MAY ARISE AFTER THE TERMINATION OF THESE TERMS OF
                          USE.
                        </p>
                        <p>
                          You and Company agree that any Dispute arising out of or related to these Terms of Use or the
                          Services is personal to you and Company, and that any Dispute will be resolved solely through
                          binding individual arbitration, and will not be brought as a class arbitration, class action
                          or any other type of representative proceeding.
                        </p>
                        <p>
                          All matters relating to the Services and these Terms of Use and any Dispute arising therefrom
                          or related thereto (in each case, including non-contractual Disputes), shall be governed by
                          and construed in accordance with the internal laws of the Cayman Islands without giving effect
                          to any choice or conflict of law provision or rule (whether of the Cayman Islands or any other
                          jurisdiction).
                        </p>
                        <p>
                          ...
                          shall be in writing and shall be final and binding on the parties, and judgment upon any award
                          thus obtained may be entered in or enforced by any court of competent jurisdiction. You shall
                          not institute any action at law or in equity based upon any claim arising out of or related to
                          these Terms of Use in any court. We retain the right to bring any suit, action, or proceeding
                          against you for breach of these Terms of Use in your country of residence or any other
                          relevant country. You waive any and all objections to the exercise of jurisdiction over you by
                          such courts and to venue in such courts. Notwithstanding the foregoing, nothing in this
                          section shall be construed to limit any right that cannot be waived or limited by applicable
                          law.
                        </p>
                        <p>
                          ...
                          knowledge of the facts founding such claim if later, and you hereby expressly agree to exclude
                          the effect of the Limitation Act (1996 Revision) in this regard.
                        </p>
                        <p>
                        ...
                        <p>
                          ...
                          or condition, and any failure of Company to assert a right or provision under these Terms of
                          Use shall not constitute a waiver of such right or provision nor shall it preclude or restrict

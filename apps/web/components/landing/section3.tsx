...
const Section3 = () => {
  return (
    <div className="big-banner h-[440px] sm:h-[480px] md:h-[560px] flex flex-col items-center bg-almost-white pt-[40px] sm:pt-[60px] relative overflow-hidden bg-[url('/section2-1.png')] bg-no-repeat bg-bottom section3">
      <Image

export const NearIcon = () => (
  <>
    {' '}
    {/* biome-ignore lint/a11y/noSvgWithoutTitle: decorative icon with aria-hidden; title would show unwanted tooltip on hover */}
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24" aria-hidden>
      <defs>
        <clipPath id="near-protocol__a">
          <rect width="24" height="24" rx="6" ry="6" />
        </clipPath>
      </defs>
      <g clipPath="url(#near-protocol__a)">
        <path fill="#00EC97" d="M24 0H0v24h24z" />
        <path
          fill="#000"

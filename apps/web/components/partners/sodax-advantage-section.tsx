    ...
    >
      <div className="flex flex-col gap-12 items-center max-w-236 mx-auto w-full">
        ...
        <div className="flex flex-col gap-4 items-center px-4">
          ...
          <p className="font-['InterRegular'] text-[14px] sm:text-[16px] leading-[1.4] text-espresso text-center">
        ...
        >
          ...
          <motion.div
            ...
            className="md:col-span-5 bg-cream-white rounded-3xl p-5 md:p-6 flex flex-col gap-3 md:gap-4"
          >
          ...
          <motion.div
            variants={{ hidden: { opacity: 0, y: 20 }, show: { opacity: 1, y: 0 } }}
            transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
            className="md:col-span-7 bg-white rounded-3xl p-5 md:p-6 flex flex-col gap-3 md:gap-4"
          >
            <div className="flex items-start gap-2">
          ...
          <motion.div
            variants={{ hidden: { opacity: 0, y: 20 }, show: { opacity: 1, y: 0 } }}
            transition={{ duration: 0.6, ease: [0.22, 1, 0.36, 1] }}
            className="md:col-span-7 bg-cream-white rounded-3xl p-5 md:p-6 flex flex-col gap-3 md:gap-4"
          >
            <div className="flex items-start gap-2">
        ...
        <motion.div
          ...
          className="bg-white rounded-3xl flex flex-col md:flex-row items-center md:items-start justify-center md:justify-between px-5 md:px-6 py-10 md:py-14 w-full gap-8 md:gap-4"
        >
          {sdkLayers.map(layer => (
            <motion.a
              key={layer.number}
              ...
              className="flex flex-1 flex-col gap-2 items-center px-4 md:px-10 hover:opacity-80 transition-opacity cursor-pointer w-full md:w-auto"
            >
              <div className="bg-cherry-grey rounded-full flex flex-col items-center justify-center size-14 md:size-16">
                <span className="font-['InterBold'] text-[16px] md:text-[18px] leading-[1.2] text-espresso">
                  {layer.number}
                </span>
              </div>
              <h3 className="font-['InterBold'] text-[16px] md:text-[18px] leading-[1.2] text-espresso text-center">
                {layer.title}
              </h3>

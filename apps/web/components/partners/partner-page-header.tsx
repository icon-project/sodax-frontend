...
import { HOME_ROUTE, PARTNERS_ROUTE } from '@/constants/routes';
...
export function PartnerPageHeader({ backLink = PARTNERS_ROUTE, backText = '← partners' }: PartnerPageHeaderProps) {
  return (

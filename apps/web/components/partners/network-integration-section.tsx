  ...
  return (
    ...
    >
      <div className="flex flex-col gap-6 items-center max-w-236 mx-auto w-full">
        ...
        {/* Subtitle */}
        <p className="font-['InterRegular'] text-[14px] sm:text-[16px] leading-[1.4] text-espresso text-center max-w-full md:max-w-130.5 px-4">
              ...
              <div className="flex flex-col gap-2 flex-1">
                {pkg.features.map(feature => (
                  <div key={feature} className="flex gap-2 items-start">
                    ...
                    <span className="font-['InterRegular'] text-[13px] sm:text-[14px] leading-[1.4] text-clay-dark">
                      {feature}
                    </span>
                  </div>
                ))}

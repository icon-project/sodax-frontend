      ...
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-[var(--espresso)]">Articles</h1>
        ...
        <Card className="border-2 border-[var(--cherry-grey)] shadow-xl">
          {loading ? (
            <div className="p-12 text-center text-[var(--clay)]">
              <div className="w-8 h-8 border-4 border-[var(--yellow-soda)] border-t-transparent rounded-full animate-spin mx-auto mb-4" />
              Loading articles...
            </div>
          ) : articles.length === 0 ? (

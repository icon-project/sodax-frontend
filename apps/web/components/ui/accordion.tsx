...
function AccordionTriggerWithButton({
  className,
  children,
  ...props
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        {isMobile ? (
          <ChevronDownIcon className="text-muted-foreground pointer-events-none size-4 shrink-0 translate-y-0.5 transition-transform duration-200 mt-4" />
        ) : (
          <Button
            variant="outline"
            size="sm"
...
export { Accordion, AccordionItem, AccordionTrigger, AccordionContent, AccordionTriggerWithButton };

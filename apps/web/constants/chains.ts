...
export const availableChains: ChainUI[] = [
  { id: CHAIN_IDS[0], name: 'Sonic', icon: '/chain/sonic.png' },
  { id: CHAIN_IDS[1], name: 'Avalanche', icon: '/chain/0xa86a.avax.png' },
  { id: CHAIN_IDS[2], name: 'Arbitrum', icon: '/chain/0xa4b1.arbitrum.png' },
  { id: CHAIN_IDS[3], name: 'Base', icon: '/chain/0x2105.base.png' },
  { id: CHAIN_IDS[4], name: 'BSC', icon: '/chain/0x38.bsc.png' },
  { id: CHAIN_IDS[5], name: 'Injective', icon: '/chain/injective-1.png' },
  { id: CHAIN_IDS[6], name: 'Sui', icon: '/chain/sui.png' },
  { id: CHAIN_IDS[7], name: 'Optimism', icon: '/chain/0xa.optimism.png' },

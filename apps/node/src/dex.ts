...
async function getPositions(tokenId: bigint): Promise<void> {
  ...
  try {
    ...
    console.log('');
    console.log('📊 Position Data Report:');
    console.log('══════════════════════════════════════════════════════════════');
    console.log('');
    console.log('🆔 Position Basics:');
    console.log(`   Token ID: ${tokenId.toString()}`);
    console.log(`   Token Pair: ${positionInfo.poolKey.currency0} / ${positionInfo.poolKey.currency1}`);
    console.log(`   Pool Manager: ${positionInfo.poolKey.poolManager}`);
    console.log(`   Fee: ${positionInfo.poolKey.fee}`);
    console.log(`   Hooks: ${positionInfo.poolKey.hooks}`);
    console.log('');
    ...
    console.log(`   Subscriber: ${positionInfo.subscriber}`);
    console.log('');
    ...
    console.log(`   Parameters: ${positionInfo.poolKey.parameters}`);
    console.log('');
    console.log('══════════════════════════════════════════════════════════════');
      ...
      JSON.stringify(
        {
          ...
          position: {
            ...
            feeGrowth: {
              inside0LastX128: positionInfo.feeGrowthInside0LastX128.toString(),
              inside1LastX128: positionInfo.feeGrowthInside1LastX128.toString(),
            },
            subscriber: positionInfo.subscriber,
          },
        },
        null,
        2,

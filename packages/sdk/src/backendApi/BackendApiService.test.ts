...
//         const mockData = {
//           success: true,
//           data: { txHash: '0xabc', srcChain: '146', status: 'pending', failedAttempts: 0 },
//         };
//         mockFetch.mockResolvedValue({ ok: true, json: vi.fn().mockResolvedValue(mockData) });
...
//       it('should get status with txHash and srcChain', async () => {
//         const mockData = {
//           success: true,
//           data: { txHash: '0xabc', srcChain: '42161', status: 'pending', failedAttempts: 0 },
//         };
//         mockFetch.mockResolvedValue({ ok: true, json: vi.fn().mockResolvedValue(mockData) });

//         await backendApiService.getSubmitSwapTxStatus({ txHash: '0xabc', srcChain: '42161' });

//         expect(mockFetch).toHaveBeenCalledWith(
//           'https://api.sodax.com/v1/be/swaps/submit-tx/status?txHash=0xabc&srcChain=42161',
//           expect.objectContaining({ method: 'GET' }),
//         );
//       });
...
//         const mockData = {
//           success: true,
//           data: { txHash: '0xabc', srcChain: '146', status: 123, failedAttempts: 0 },
//         };
//         mockFetch.mockResolvedValue({ ok: true, json: vi.fn().mockResolvedValue(mockData) });
...
//       await expect(backendApiService.getOrderbook({ offset: '0', limit: '5' }, { timeout: 5 })).rejects.toThrow(

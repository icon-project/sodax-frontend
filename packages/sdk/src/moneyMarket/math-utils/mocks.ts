...
} from './formatters/incentive/index.js';
import type { FormatReserveUSDResponse, ReserveData } from './formatters/reserve/index.js';
import type { UserReserveDataString } from './formatters/user/index.js';
...
export class ReserveMock {
  ...
  addUnbacked(amount: number | string) {
    this.reserve.unbacked = new BigNumber(amount).shiftedBy(this.config.decimals).toString();
    return this;
  }
}

export class UserReserveMock {
  public userReserve: UserReserveDataString;

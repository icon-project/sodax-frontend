...
const hubChainConfig: Record<HubChainId, EvmHubChainConfig> = {
  [SONIC_MAINNET_CHAIN_ID]: {
    ...
    addresses: {
      ...
      stakedSoda: '0x4333B324102d00392038ca92537DfbB8CB0DAc68', // TODO: Add actual StakedSoda contract address
      xSoda: '0xADC6561Cc8FC31767B4917CCc97F510D411378d9', // TODO: Add actual xSoda contract address
    },
...
export const spokeChainConfig = {
  ...
  [SUI_MAINNET_CHAIN_ID]: {
    addresses: {
      ...
      assetManager:
        '0x71535403c625ebf004135f52c8691cb0b740f801f19beb43791cb2cecc6f37ae::asset_manager::0xcb7346339340b7f8dea40fcafb70721dc2fcfa7e8626a89fd954d46c1f928b61',
      xTokenManager: '',
      rateLimit: '',
      testToken: '',
    },
  ...
  [ICON_MAINNET_CHAIN_ID]: {
    ...
    supportedTokens: {
      ...
      SODA: {
        ...
        name: 'SODAX',
        decimals: 18,
        address: 'cx0000000000000000000000000000000000000000', // TODO: Add actual SODA token address for ICON
        xChainId: ICON_MAINNET_CHAIN_ID,
      },
    } as const,
...
> = {
  ...
  [AVALANCHE_MAINNET_CHAIN_ID]: {
    ...
    [spokeChainConfig[AVALANCHE_MAINNET_CHAIN_ID].bnUSD]: {
      ...
      symbol: 'bnUSD',
      name: 'bnUSD',
      vault: hubVaults.sodabnUSD.address,
    },
  ...
  [ICON_MAINNET_CHAIN_ID]: {
    ...
    SODA: {
      asset: '0x655730024B673B3378CD6031B1Cd01eaE9afb138',
      decimal: 18,
      symbol: 'SODA',
      name: 'SODAX',
      vault: hubVaults.sodaSODA.address,

// packages/sdk/src/services/concentratedLiquidity/AssetService.ts
import type { Address, Hex } from 'viem';
import { EvmSpokeProvider, type EvmHubProvider } from '../../entities/index.js';
import {
...
export class AssetService {
  ...
  constructor(config: AssetServiceConfigParams | undefined, hubProvider: EvmHubProvider, relayerApiEndpoint?: HttpUrl) {
  ...
  public async isAllowanceValid(
    ...
    try {
      ...
      return {
        ok: false,
        error: {
          code: 'ALLOWANCE_CHECK_FAILED' as const,
          data: {
            error: error,
            payload: params,
          },

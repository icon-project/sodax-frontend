  ...
  [SONIC_MAINNET_CHAIN_ID]: {
    ...
    supportedTokens: {
      ...
      sftUSD: {
        ...
        name: 'Staked ftUSD',
        decimals: 6,
        address: '0xd1e5a86f1005f6356bd022c587de0f430cd2aeb1',
        xChainId: SONIC_MAINNET_CHAIN_ID,
      },
      ...SodaTokens,
    },
...
export const swapSupportedTokens = {
  [SONIC_MAINNET_CHAIN_ID]: [
    ...
    spokeChainConfig[SONIC_MAINNET_CHAIN_ID].supportedTokens.ftUSD,
    spokeChainConfig[SONIC_MAINNET_CHAIN_ID].supportedTokens.sftUSD,

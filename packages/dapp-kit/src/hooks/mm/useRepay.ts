import type { HubTxHash, MoneyMarketRepayActionParams, MoneyMarketRepayParams, SpokeTxHash } from '@sodax/sdk';
 ...
 */
export type UseRepayVars<K extends SpokeChainKey = SpokeChainKey> = {
